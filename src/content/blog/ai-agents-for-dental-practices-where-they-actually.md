...
sources:
  ...
  - "Manual insurance verification time (Curve Dental) — https://www.curvedental.com/blog/verifying-dental-insurance"
  - "Recall/attrition benchmarks (DialogHealth; eAssist) — https://www.dialoghealth.com/post/patient-reactivation-statistics"
  - "When AI becomes a HIPAA business associate / BAA requirements (Paubox; Medcurity) — https://www.paubox.com/blog/when-does-ai-become-a-business-associate-under-hipaa"
  - "HIPAA compliance for generative AI, consumer tools and BAAs (Medcurity) — https://medcurity.com/hipaa-compliance-generative-ai/"
  - "Dental practice management market (Dentrix, Eaglesoft, Open Dental) (Siotek) — https://siotek.net/resources/dental-practice-management-software-comparison"
---

If your front desk spends half its day on the phone confirming appointments, chasing insurance details, and trying to refill a chair that just opened up, you've probably wondered whether "AI" can take some of that off their plate. The honest answer is: some of it, yes. There are also a few things you should keep well away from it.
...
**Loose handling of patient data.** This is the big one. Under HIPAA, any vendor whose software touches protected health information counts as a "business associate," and you must have a signed Business Associate Agreement (BAA) with them before that data flows. Public, consumer versions of tools like ChatGPT or Gemini do **not** sign BAAs, so pasting patient details into them is a violation. Only use a vendor who will sign a BAA and will contractually promise not to use your patients' data to train their models.
