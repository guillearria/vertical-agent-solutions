...
sources:
  ...
  - "Medical spa receptionist hourly pay (Indeed) — https://www.indeed.com/cmp/Med-Spa/salaries/Front-Desk-Receptionist"
  - "Medical spa receptionist salary (Salary.com) — https://www.salary.com/research/salary/hiring/medical-spa-receptionist-salary"
  - "Med spa daily visit volume and KPIs (Financial Models Lab) — https://financialmodelslab.com/blogs/kpi-metrics/medical-spa"
  - "AI receptionist pricing 2026 (AgentZap) — https://agentzap.ai/blog/ai-receptionist-pricing-complete-cost-guide-2025"
  - "Med spa revenue and injectables share (American Med Spa Association) — https://www.americanmedspa.org/med-spa-statistics/"
  - "Who can perform a good faith exam (American Med Spa Association) — https://www.americanmedspa.org/news/what-is-required-of-a-medical-spas-good-faith-exams/"
---
...
Here's a typical week, task by task. These are estimates from how appointment-heavy clinics describe their days, not lab numbers, so treat them as a starting point to test against your own book.
...
Add that up and you're realistically clawing back **9–11 hours a week**, or roughly **$240–$290 in loaded labor**. Over a year, call it **$12,000–$15,000**. That's not the whole $21,600, because a person still handles the messy 30%.
...
AI receptionist and booking tools for small businesses generally run **$99–$299 a month** for full coverage with booking and calendar integration, with budget options from $49. Watch for per-minute overage charges, which are the most common surprise on the bill. Budget **$150–$250/month**, roughly **$1,800–$3,000/year**.
...
So the agent books, reminds, and collects deposits. It must **never** tell a patient whether Botox is right for them, how many units they need, adjust a treatment plan, give aftercare advice, or capture medical consent. Those touch the practice of medicine. The same rule that keeps [dental front desks HIPAA-safe](/blog/ai-agents-for-dental-practices-where-they-actually/) applies here: the agent handles logistics, the licensed human handles clinical judgment. Draw that boundary in writing before you turn anything on.
