...
What it does *not* do is quote a discount, promise waiver eligibility, or estimate authorized hours. Medicaid-funded personal care visits also have to run through electronic visit verification under the 21st Century Cures Act, so the agent flags the payer question and a human confirms.
