...
**Where it fails:** Coverage and turnover. One person means one vacation, one flu, one resignation. And a 20-hour coordinator handling 25 RFQs is close to fully booked, so growth means a second hire.
...
The honest answer for most 5–50 person shops is a combination: the agent does intake and chasing, and a human (coordinator or estimator) approves the extraction and owns everything downstream.
