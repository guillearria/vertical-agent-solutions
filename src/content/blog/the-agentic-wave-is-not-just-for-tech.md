...
- A salon loses walk-in bookings to a busy phone line, then worries the agent will double-book the chair, but [most of those fears don't survive contact with the details](/blog/no-it-wont-double-book-you-the-myths-salons/).
